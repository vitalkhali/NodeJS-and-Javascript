...
function preload() {
  ...
  mySound = loadSound('Sounds/BackgroundMusic.m4a');
...
function draw() {
  ...
  for (var i = 0; i < 20; i++) {
    bees.push(new Bee(random(1000, 42000), random(60, windowHeight - 300)));
  ...
  for (var i = 0; i < 20; i++) {
    madFlies.push(new Madfly(random(1000, 42000), random(60, windowHeight - 300)));
  ...
  for (var i = 0; i < 20; i++) {
    ghosts.push(new Ghost(random(1000, 42000), random(60, windowHeight - 300)));
    ghosts[i].fly();
    ghosts[i].draw();
  ...
  for (var i = 0; i < 20; i++) {
    bats.push(new Bat(random(1000, 42000), random(60, windowHeight - 300)));
    bats[i].fly();
    bats[i].draw();
